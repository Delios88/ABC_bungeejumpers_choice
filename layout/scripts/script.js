...
//Javascript for google map -- without api key (I'm so sorry, I don't have the billing account, so no API key)
function myMap() {
  ...
  var map1 = new google.maps.Map(document.getElementById("googleMap1"),mapProp); //Bali
  var map2 = new google.maps.Map(document.getElementById("googleMap2"), mapOptions2); //Waterfall
  var map3 = new google.maps.Map(document.getElementById("googleMap3"), mapOptions3); //Victoria Bridge
  var map4 = new google.maps.Map(document.getElementById("googleMap4"), mapOptions4); //Macau Tower
  }
